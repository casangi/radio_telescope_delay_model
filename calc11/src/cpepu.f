...
!     INCLUDE 'param11.i'
      INCLUDE 'd_input.i'
!       Variables from:
!         1. JPL_421 - Character string giving the complete path name of the
!                      JPL DE421 ephemeris. This is now passed into subroutine
!                      almacalc. 
!
...
!                          file.
!      D.Gordon 2019.03.18 JPL ephemeris name now paased in d_input.i.
!                          
!----------------------------------------------------------------------
!
