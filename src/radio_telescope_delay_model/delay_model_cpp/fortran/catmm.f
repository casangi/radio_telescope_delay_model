...
!
!************************************************************************
      SUBROUTINE ATMP ( SITLAT, SITLON, SITHEIGHT, XJD, CT,             &
...
!
!   Now do the dry and wet atmosphere delay (Nhmf and Whmf) contributions:
!
!     Met values, either measured or a priori computed:
        If (SurTP(N) .gt. -90.D0) Then
          Temp = SurTP(N)
          Tdot = 0.D0
        Else
...
!
        ...
        Else
          ...
          Rdot  = 0.D0
        Endif
!        write(6,*) 'catmm: Sithit,Temp,Press,Relhum ', Sithit,Temp,Press,Relhum
!
...
!      write(6,*) 'surTp,surPr,surHm: ', surTp,surPr,surHm
!      write(6,*) 'Zen_dry', Zen_dry
!      write(6,*) 'Zen_wet', Zen_wet
!
!
!    Check for debug output.
      IF ( KATMD .ne. 0 )  Then
